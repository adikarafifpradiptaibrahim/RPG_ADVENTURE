...
export const WorldMapModal: React.FC<WorldMapModalProps> = ({
  ...
  // World bounds: X from -140 to +145 (width 285), Z from -120 to +75 (height 195)
  const minX = -140;
  const maxX = 145;
  const minZ = -120;
  const maxZ = 75;
          ...
          <div className="relative flex-1 bg-stone-950/90 overflow-hidden flex items-center justify-center p-4">
            ...
            <div className="relative w-full h-full max-w-[620px] max-h-[580px] rounded-xl overflow-hidden border border-stone-700/60 shadow-inner bg-[#1e232a]">
              ...
              <div
                ...
                className="absolute top-0 right-0 w-[35%] h-[38%] bg-gradient-to-bl from-[#0c4a6e] via-[#0284c7]/40 to-transparent border-l border-b border-sky-400/40 cursor-pointer hover:brightness-125 transition-all z-10"
              >
              ...
              <div
                ...
                className="absolute top-0 left-[26%] w-[39%] h-[34%] bg-gradient-to-b from-[#211210] via-[#2d1815] to-transparent border-b border-red-900/40 cursor-pointer hover:brightness-110 transition-all z-5"
              >
