...
export function createDesertPalmMesh(): THREE.Group {
  ...
  // Curving Trunk
  const trunk1 = new THREE.Mesh(new THREE.CylinderGeometry(0.28, 0.38, 3.2, 6), trunkMat);
  trunk1.position.set(0, 1.6, 0);
...
export function createCherryBlossomTreeMesh(): THREE.Group {
  ...
  // Gnarled Trunk
  const trunk1 = new THREE.Mesh(new THREE.CylinderGeometry(0.35, 0.55, 3.4, 7), trunkMat);
  trunk1.position.set(0, 1.7, 0);
  tree.add(trunk1);
